...
import { FileText, Database, CheckCircle2, Clock, AlertCircle, ArrowRight } from "lucide-react";
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back to PROCUREDATA. Here's your data governance overview.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-primary/20 bg-gradient-subtle">
          <CardHeader>
            ...
            <CardDescription>
              Explore available data assets and request access
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/catalog">
        ...
        <Card className="border-accent/20 bg-gradient-subtle">
          <CardHeader>
            ...
            <CardDescription>
              Review and approve pending data requests
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link to="/transactions">

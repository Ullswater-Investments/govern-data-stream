...
export type Database = {
  ...
  public: {
    Tables: {
      data_assets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "data_assets_provider_org_id_fkey"
      ...
      data_transactions: {
        Row: {
          ...
          holder_approved_by: string | null
          holder_org_id: string
          id: string
          provider_org_id: string
          purpose: string | null
          ...
          subject_approved_at: string | null
          subject_approved_by: string | null
          updated_at: string
        }
        Insert: {
          asset_id: string
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "data_transactions_provider_org_id_fkey"
            columns: ["provider_org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "consumer" | "provider" | "holder"
      data_type: "iot" | "esg" | "financial" | "array"
      transaction_status:
        | "initiated"
        | "pending_subject"
        | "pending_holder"
